...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header" style="color:#1a98a6">Admin Dashboard</h1>
        </div>
        <div class="col-lg-12">
            <div id="reportrange" class="pull-right" style="background:#1a98a6; color:#fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div id="morris-area-chart" style="color:#1a98a6"></div>
                </div>
            </div>
        </div>
    </div>
